	...
	return (
		<>
			<div className="container relative h-screen flex-col items-center justify-center grid md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
				<Link to="/join" className={cn(buttonVariants({ variant: "ghost" }), "absolute right-4 top-4 md:right-8 md:top-8")}>
					Join
				</Link>
				...
				<div className="lg:p-8">
					<div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
						<div className="flex flex-col space-y-2 text-center">
							...
							<p className="text-sm text-muted-foreground">Fill out the form below to log in to your account.</p>
						</div>
						<UserAuthForm />
					</div>
				</div>
